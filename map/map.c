...
//make sure if we need to print error to the user
...
MapResult mapPut(Map map, MapKeyElement keyElement, MapDataElement dataElement)
{
    ...
    if(mapContains(map, keyElement)) //in case we need to replace data element associated with a given key:
    {
    ...
    else //in case we need to insert a whole new element:
    {
